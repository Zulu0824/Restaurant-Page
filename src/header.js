...
headerSection.appendChild(headerBottom);

headerBottom.appendChild(headerLogo);   
headerBottom.appendChild(navSection);   
headerBottom.appendChild(bookTableBtn);
...
headerTitle.textContent = "PATAKA";
